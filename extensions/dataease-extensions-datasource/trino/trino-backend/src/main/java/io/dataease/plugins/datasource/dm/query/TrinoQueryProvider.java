        ...
        if (CollectionUtils.isNotEmpty(fields)) {
            for (int i = 0; i < fields.size(); i++) {
                ...
                if (f.getDeExtractType() == DeTypeConstants.DE_TIME) {
                    ...
                    if (f.getDeType() == DeTypeConstants.DE_INT) {
                        fieldName = String.format(TrinoConstants.CAST, originField,
                                TrinoConstants.DEFAULT_INT_FORMAT);
                    } else if (f.getDeType() == DeTypeConstants.DE_FLOAT) {
                        fieldName = String.format(TrinoConstants.CAST, originField,
                                TrinoConstants.DEFAULT_FLOAT_FORMAT);
                    } else if (f.getDeType() == DeTypeConstants.DE_TIME) {
...
//                                        : TrinoConstants.DEFAULT_DATE_FORMAT);
                    ...
                    if (f.getDeType() == DeTypeConstants.DE_TIME) {
                        String cast = String.format(TrinoConstants.CAST, originField, "bigint");
                        fieldName = String.format(TrinoConstants.FROM_UNIXTIME, cast);
                    } else if (f.getDeType() == DeTypeConstants.DE_INT) {
                        fieldName = String.format(TrinoConstants.CAST, originField,
                                TrinoConstants.DEFAULT_INT_FORMAT);
                    } else {
